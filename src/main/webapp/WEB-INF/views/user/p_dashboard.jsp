                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                          <td class="mailbox-name"><a href="read-mail.html">Alexander Pierce</a></td>
                          <td class="mailbox-subject"><b>AdminLTE 2.0 Issue</b> - Trying to find a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problend a solution to this problem...</td>
                          <td class="mailbox-attachment"><i class="fa fa-paperclip"></i></td>
